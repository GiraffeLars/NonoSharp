...
namespace NonoSharp.Tests
{
    public class SolverTests
    {
        ...
        public void TestEdgeFilledSolvability()
        {
            ...
            new OldSolverStrategy().ImproveLine(line, grid.RowHints[0]);
        ...
        public void Test15x15Grid()
        {
            ...
            Assert.False(Solver.IsSolvable(grid, new OldSolverStrategy()));
            ...
            Assert.True(Solver.IsSolvable(grid, new OldSolverStrategy()));

        }

        [Fact]
        public void Test15x15GridDFS()
        {
            Grid grid = new(15, 15);
            grid.SetSolution([
                new CellPosition(0, 0),
        ...
        [Fact]
        public void Test15x15GridUniqueQueue()
        {
            Grid grid = new(15, 15);
            grid.SetSolution([
                new CellPosition(0, 0),
            ...
            Assert.False(Solver.IsSolvable(grid, new UniqueQueueStrategy()));
            ...
            Assert.True(Solver.IsSolvable(grid, new UniqueQueueStrategy()));
